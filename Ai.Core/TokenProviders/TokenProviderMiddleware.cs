...
namespace Ai.Core.TokenProviders
{
    /// <summary>
    ...
    public class TokenProviderMiddleware
    {
        ...
        private async Task GenerateToken(HttpContext context)
        {
            ...
            var claims = new Claim[]
            {
                ...
                new Claim(JwtRegisteredClaimNames.Iat, Core.TokenProviders.TokenProviderMiddleware. ToUnixEpochDate(now).ToString(), ClaimValueTypes.Integer64)
            };
